...
class DynamicModel(gm.GeometricModel):
    ...
    def __init__(self, objinit, mass=None, betransparency=True, cm_cdtype="box", cm_expradius=None,
        ...
        # else:
        super().__init__(objinit.objcm, btransparency=betransparency, type=cm_cdtype, cm_expradius=None,
                         name="defaultname")
        if mass is None:
            mass = 0
