...
# import modeling._gimpact_cdhelper as moh
# import modeling._bullet_cdhelper as moh
...
class CollisionModel(gm.GeometricModel):
    ...
    def change_cdprimitive_type(self, cdprimitive_type='ball', expand_radius=.01, userdefined_cdprimitive_fn=None):
        ...
        :param expand_radius:
        :param userdefined_cdprimitive_fn: None, only used when cdprim_type == 'userdefined'
        :return:
        author: weiwei
        date: 20210116
        """
