...
class Ur3EDualUrx():
    ...
    def opengripper(self, speedpercentage=5, forcepercentage=10, distance=100, armname="rgt"):
        ...
        pr = self.__hand.ret_program_to_run(mode="open", speedpercentage=speedpercentage,
    ...
    def closegripper(self, speedpercentage=100, forcepercentage=100, armname='rgt'):
        ...
        if armname == 'lft':
            targetarm = self.__lftarm
        pr = self.__hand.ret_program_to_run(mode="close", speedpercentage=speedpercentage,
