...
if __name__ == '__main__':
    ...
    object1 = cm.CollisionModel(initor="./part_studio_1.stl", cdprimitive_type="box", cdmesh_type="convex_hull")
    object1.set_rgba([.9, .75, .35, 1])
    object1.set_pos(np.array([0, -.08, 0]))

    object2 = cm.CollisionModel(initor="./part_studio_2.stl", cdprimitive_type="box", cdmesh_type="convex_hull")
