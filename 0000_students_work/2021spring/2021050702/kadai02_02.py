...
if __name__ == "__main__":
    ...
    # 障害物を配置します
    glass1 = cm.CollisionModel(initor="objects/glass1.stl", cdprimitive_type="surface_balls", cdmesh_type="convex_hull")
    glass1.set_rgba([.9, .75, .35, 1])  # 黄色に変更
    glass1.set_pos(np.array([.25, -.3, .2]))
    star1 = cm.CollisionModel(initor="objects/star2.stl", cdprimitive_type="surface_balls", cdmesh_type="convex_hull")
