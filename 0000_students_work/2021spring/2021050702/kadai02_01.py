...
if __name__ == '__main__':
    ...
    glass1 = cm.CollisionModel(initor="objects/glass1.stl", cdp_type="surface_balls", cdm_type="convex_hull")
    glass1.set_rgba([.9, .75, .35, 1])  # 黄色に変更
    glass1.set_pos(np.array([0, -.06, 0]))
    star1 = cm.CollisionModel(initor="objects/star2.stl", cdp_type="surface_balls", cdm_type="convex_hull")
