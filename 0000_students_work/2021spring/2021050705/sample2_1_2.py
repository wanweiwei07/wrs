...
if __name__ == '__main__':
    ...
    #カップ1(緑)の生成
    object1 = cm.CollisionModel(initor="./objects/01cup.stl", cdprimitive_type="box", cdmesh_type="convex_hull")
    object1.set_rgba([0, 1, 0, 1])
    object1.set_pos(np.array([0, 0, 0]))
    #カップ2(青)の生成
    object2 = cm.CollisionModel(initor="./objects/02cup.stl", cdprimitive_type="box", cdmesh_type="convex_hull")
