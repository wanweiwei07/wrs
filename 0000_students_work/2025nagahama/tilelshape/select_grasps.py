...
for grasp1 in grasp_groups[i1].grasps:
    ...
    for grasp2 in grasp_groups[i2].grasps:
        ...
        for grasp3 in grasp_groups[i3].grasps:
            ...
            # show grasp1
            gripper.grip_at_by_pose(jaw_center_pos=grasp1.ac_pos, jaw_center_rotmat=grasp1.ac_rotmat,jaw_width=grasp1.ee_values)
            gripper.gen_meshmodel(rgb=grasp_groups[i1].color, alpha=0.5).attach_to(base)
