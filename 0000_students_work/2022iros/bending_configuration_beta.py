...
# gm.gen_stick(spos=sec2_spos, epos=sec2_spos+sec_len, rgba=rgba, major_radius=.015).attach_to(base)
...
# gm.gen_circarrow(axis=sec2_rotaxis, center=sec2_rotaxis / 13+sec2_spos, starting_vector=np.array([-0,-1,0]),major_radius=.025, portion=.5, major_radius=.003, rgba=[1,.4,0,1]).attach_to(base)
#
