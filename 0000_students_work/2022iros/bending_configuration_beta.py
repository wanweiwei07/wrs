...
# mgm.gen_stick(spos=sec2_spos, epos=sec2_spos+sec_len, rgba=rgba, major_radius=.015).attach_to(base)
# mgm.gen_frame(pos=sec2_spos, rotmat=sec2_rotmat, alpha=.2).attach_to(base)
# mgm.gen_stick(spos=sec2_spos, epos=sec2_epos, rgba=rgba, major_radius=.015).attach_to(base)
# mgm.gen_circarrow(axis=sec2_rotaxis, center=sec2_rotaxis / 13+sec2_spos, starting_vector=np.array([-0,-1,0]),major_radius=.025, portion=.5, major_radius=.003, rgba=[1,.4,0,1]).attach_to(base)
#
...
gm.gen_dashed_frame(pos=sec2_spos, rotmat=sec2_rotmat2.dot(sec2_rotmat), alpha=.2).attach_to(base)
...
sec2_rotmat3 = rm.rotmat_from_axangle(sec2_rotaxis3, angle/2)
...
# # mgm.gen_stick(spos=sec1_spos, epos=sec1_epos, rgba=rgba, major_radius=.015).attach_to(base)
# mgm.gen_dashframe(pos=sec2_spos).attach_to(base)
gm.gen_dashed_frame(pos=sec2_spos, rotmat=sec2_rotmat3.dot(sec2_rotmat2).dot(sec2_rotmat)).attach_to(base)
gm.gen_stick(spos=sec2_spos, epos=sec2_epos, rgba=rgba, radius=.015).attach_to(base)
gm.gen_circarrow(axis=sec2_rotaxis3, center=-sec2_rotaxis3 / 13+sec2_spos, starting_vector=np.array([.3,0,-1]),radius=.025, portion=.7, thickness=.003, rgba=[1,.4,0,1]).attach_to(base)
