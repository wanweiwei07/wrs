...
# gm.gen_stick(spos=sec2_spos, epos=sec2_epos, rgba=rgba, thickness=.015).attach_to(base)
...
gm.gen_dashframe(pos=sec2_spos,rotmat=sec2_rotmat2.dot(sec2_rotmat), alpha=.2).attach_to(base)
gm.gen_stick(spos=sec2_spos, epos=sec2_epos, rgba=rgba, thickness=.015).attach_to(base)
...
# # gm.gen_stick(spos=sec1_spos, epos=sec1_epos, rgba=rgba, thickness=.015).attach_to(base)
# gm.gen_dashframe(pos=sec2_spos).attach_to(base)
gm.gen_dashframe(pos=sec2_spos,rotmat=sec2_rotmat3.dot(sec2_rotmat2).dot(sec2_rotmat)).attach_to(base)
gm.gen_stick(spos=sec2_spos, epos=sec2_epos, rgba=rgba, thickness=.015).attach_to(base)
