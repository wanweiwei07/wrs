...
gm.gen_dashframe(pos=sec2_spos,rotmat=sec2_rotmat2.dot(sec2_rotmat)).attach_to(base)
gm.gen_stick(spos=sec2_spos, epos=sec2_epos, rgba=rgba, thickness=.015).attach_to(base)
...
# gm.gen_stick(spos=sec2_spos, epos=sec2_epos, rgba=rgba, thickness=.015).attach_to(base)
# gm.gen_circarrow(axis=sec2_rotaxis3, center=sec2_rotaxis3 / 13+sec2_spos, starting_vector=np.array([0,0,1]),radius=.025, portion=.55, thickness=.003, rgba=[1,.4,0,1]).attach_to(base)
