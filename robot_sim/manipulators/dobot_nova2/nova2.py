...
class Nova2(mi.ManipulatorInterface):
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6), name='nova2', enable_cc=True):
        ...
        self.jlc.jnts[2]['loc_rotmat'] = np.array([[1.15684894e-04, -9.99999993e-01, 0.00000000e+00],
        ...
        self.jlc.jnts[4]['loc_rotmat'] = np.array([[-9.54658556e-05, 9.99999995e-01, 0.00000000e+00],
        ...
        self.jlc.jnts[5]['loc_rotmat'] = np.array([[1.00000000e+00, -0.00000000e+00, 0.00000000e+00],
        ...
        self.jlc.jnts[6]['loc_rotmat'] = np.array([[-9.99996405e-01, -2.68157574e-03, 0.00000000e+00],
        ...
        self.jlc.lnks[6]['loc_rotmat'] = np.array([[-9.99996404e-01, 1.64199157e-19, 2.68157574e-03],
