...
class SIA5(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(7), name='sia5', enable_cc=True):
        ...
        self.jlc.joints[1]['pos_in_loc_tcp'] = np.array([0, 0, .31])
        ...
        self.jlc.joints[7]['gl_rotmat'] = rm.rotmat_from_euler(-1.5708, 0, 0)
        ...
        self.jlc.joints[8]['gl_rotmat'] = rm.rotmat_from_euler(-1.5708, -1.5708, -1.5708)
        # links
