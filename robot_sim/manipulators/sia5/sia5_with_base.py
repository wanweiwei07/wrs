...
class SIA5(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(7), name='sia5', enable_cc=True):
        ...
        self.jlc.jnts[1]['pos_in_tcp'] = np.array([0, 0, .31])
        ...
        self.jlc.jnts[5]['pos_in_tcp'] = np.array([.27, -0, .06])
        ...
        self.jlc.jnts[7]['pos_in_tcp'] = np.array([.134, .0, .0])
        ...
        self.jlc.jnts[8]['pos_in_tcp'] = np.array([.011, .0, .0])
        ...
        self.jlc.lnks[3]['pos_in_tcp'] = np.zeros(3)
        ...
        self.jlc.lnks[4]['pos_in_tcp'] = np.zeros(3)
        ...
        self.jlc.lnks[5]['pos_in_tcp'] = np.zeros(3)
        ...
        self.jlc.lnks[6]['pos_in_tcp'] = np.zeros(3)
        ...
        self.jlc.lnks[7]['pos_in_tcp'] = np.zeros(3)
