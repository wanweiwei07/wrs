...
class XArmLite6(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.array([0., 0.173311, 0.555015, 0., 0.381703, 0.]),
        ...
        # joint 1
        self.jlc.jnts[1]['pos_in_tcp'] = np.array([0., 0., .2433])
        ...
        # joint 3
        self.jlc.jnts[3]['pos_in_tcp'] = np.array([.2, 0., 0.])
        ...
        # joint 4
        self.jlc.jnts[4]['pos_in_tcp'] = np.array([.087, -.2276, 0.])
        ...
        # joint 5
        self.jlc.jnts[5]['pos_in_tcp'] = np.array([0., 0., 0.])
        ...
        # joint 6
        self.jlc.jnts[6]['pos_in_tcp'] = np.array([0., .0615, 0.])
