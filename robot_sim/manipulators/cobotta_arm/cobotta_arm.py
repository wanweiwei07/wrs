...
class CobottaArm(mi.ManipulatorInterface):
    ...
    def __init__(self,
        ...
        # anchor
        self.jlc.anchor.lnk.cmodel = mcm.CollisionModel(os.path.join(file_dir, "meshes", "base_link.dae"))
        ...
        self.jlc.jnts[0].lnk.cmodel = mcm.CollisionModel(os.path.join(file_dir, "meshes", "j1.dae"))
        ...
        self.jlc.jnts[1].lnk.cmodel = mcm.CollisionModel(os.path.join(file_dir, "meshes", "j2.dae"))
        ...
        self.jlc.jnts[2].lnk.cmodel = mcm.CollisionModel(os.path.join(file_dir, "meshes", "j3.dae"))
        ...
        self.jlc.jnts[3].lnk.cmodel = mcm.CollisionModel(os.path.join(file_dir, "meshes", "j4.dae"))
        ...
        self.jlc.jnts[4].lnk.cmodel = mcm.CollisionModel(os.path.join(file_dir, "meshes", "j5.dae"))
        ...
        self.jlc.jnts[5].lnk.cmodel = mcm.CollisionModel(os.path.join(file_dir, "meshes", "j6.dae"))
