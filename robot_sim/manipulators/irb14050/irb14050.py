...
class IRB14050(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(7), name='irb14050', enable_cc=True):
        ...
        # self.jlc.joints[1]['loc_pos'] = np.array([0.05355, -0.0725, 0.41492])
...
if __name__ == '__main__':
    ...
    manipulator_instance.fk(
        jnt_values=[0, 0, manipulator_instance.jnts[3]['motion_range'][1] / 2, manipulator_instance.jnts[4]['motion_range'][1], 0, 0, 0])
    ...
    manipulator_instance2.fk(
        joint_values=[0, 0, manipulator_instance.jnts[3]['motion_range'][1] / 2, manipulator_instance.jnts[4]['motion_range'][1] * 1.1,
