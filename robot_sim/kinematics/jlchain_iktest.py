...
class JLChain(object):
    ...
    def forward_kinematics(self, joint_values=None, toggle_jacobian=True, update=False, toggle_debug=False):
        """
        ...
        """
        if not update and joint_values is not None:
        ...
        if update and joint_values is not None:
            pos = self.anchor.pos
