...
class WRSGripper4(gpi.GripperInterface):
    """
    This class is the second version of Junbo's extension gripper. It is designed to be used with Denso Cobotta
    author: weiwei
    date: 20240909
    """

    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3),
                 cdmesh_type=mcm.mc.CDMType.DEFAULT, name="wrs_gripper4"):
        ...
        self.jlc.anchor.lnk_list[0].cmodel.rgba = rm.bc.dim_gray
        # rack length
