...
class Robotiq85(gi.GripperInterface):
    ...
    def __init__(self,
        ...
        self.palm.lnk_list[0].cmodel = mcm.CollisionModel(
            initor=os.path.join(current_file_dir, "meshes", "robotiq_arg2f_85_base_link_cvt.stl"),
        ...
        self.lft_outer_jlc.jnts[2].lnk.cmodel = mcm.CollisionModel(
            os.path.join(current_file_dir, "meshes", "robotiq_arg2f_85_inner_finger_cvt2.stl"),
            cdmesh_type=self.cdmesh_type)
        ...
        self.lft_inner_jlc.jnts[0].lnk.cmodel = mcm.CollisionModel(
            os.path.join(current_file_dir, "meshes", "robotiq_arg2f_85_inner_knuckle_cvt.stl"),
            cdmesh_type=self.cdmesh_type)
