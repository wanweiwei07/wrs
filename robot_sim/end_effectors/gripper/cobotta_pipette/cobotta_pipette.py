...
class CobottaPipette(gp.GripperInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), cdmesh_type='box', name='robotiqhe', enable_cc=True):
        ...
        self.jlc = jl.JLChain(pos=cpl_end_pos, rotmat=cpl_end_rotmat, homeconf=np.zeros(3), name='base_lft_finger')
        self.jlc.jnts[2]['loc_pos'] = np.array([0, .0, .06])
        self.jlc.jnts[2]['type'] = 'prismatic'
        self.jlc.jnts[2]['motion_rng'] = [0, .015]
        self.jlc.jnts[2]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.jnts[3]['loc_pos'] = np.array([0, .0, .0])
        self.jlc.jnts[3]['type'] = 'prismatic'
        ...
        self.jlc.lnks[1]['name'] = "pipette"
        self.jlc.lnks[1]['loc_pos'] = np.zeros(3)
        self.jlc.lnks[1]['mesh_file'] = os.path.join(this_dir, "meshes", "p1000g.stl")
        self.jlc.lnks[1]['rgba'] = [.35, .35, .35, 1]
        self.jlc.lnks[2]['name'] = "finger1"
        self.jlc.lnks[2]['loc_pos'] = np.array([0, 0, -.06])
        self.jlc.lnks[2]['mesh_file'] = os.path.join(this_dir, "meshes", "left_finger.dae")
        self.jlc.lnks[2]['rgba'] = [.5, .5, .5, 1]
        self.jlc.lnks[3]['name'] = "finger2"
        self.jlc.lnks[3]['loc_pos'] = np.array([0, 0, -.06])
        self.jlc.lnks[3]['mesh_file'] = os.path.join(this_dir, "meshes", "right_finger.dae")
