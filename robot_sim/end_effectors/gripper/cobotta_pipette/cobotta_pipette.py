...
class CobottaPipette(gp.GripperInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), cdmesh_type='box', name='cobotta_pipette', enable_cc=True):
        ...
        self.jlc.lnks[1]['pos_in_tcp'] = np.array([.008, .04, .08575])
        ...
        self.jlc.lnks[2]['pos_in_tcp'] = np.array([.008, .04, .03575])
        ...
        self.jlc.lnks[3]['pos_in_tcp'] = np.array([.008, .14275, .06075])
        ...
        self.jlc.lnks[4]['pos_in_tcp'] = np.array([.008, .14275, .06075])
        ...
        self.jlc.lnks[6]['pos_in_tcp'] = np.array([.008, .14355, .06075])
        ...
        self.jlc.lnks[7]['pos_in_tcp'] = np.array([0, 0, .0])
        ...
        self.jlc.lnks[8]['pos_in_tcp'] = np.array([.008, .14355, .06075])
