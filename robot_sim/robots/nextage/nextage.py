...
class Left_Manipulator(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(7), name='nextage_left_manipulator'):
        ...
        self.jlc.joints[2]['pos_in_loc_tcp'] = np.array([0, 0.145, 0.370296])
        self.jlc.joints[2]['gl_rotmat'] = rm.rotmat_from_euler(-0.261799, 0, 0)
        self.jlc.joints[2]['loc_motionax'] = np.array([0, 0, 1])
        self.jlc.joints[2]['motion_rng'] = [-1.53589, 1.53589]
        self.jlc.joints[3]['pos_in_loc_tcp'] = np.array([0, 0, 0])
        self.jlc.joints[3]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.joints[3]['motion_rng'] = [-2.44346, 1.0472]
        self.jlc.joints[4]['pos_in_loc_tcp'] = np.array([0, 0.095, -0.25])
        self.jlc.joints[4]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.joints[4]['motion_rng'] = [-2.75762, 0]
        self.jlc.joints[5]['pos_in_loc_tcp'] = np.array([-0.03, 0, 0])
        self.jlc.joints[5]['loc_motionax'] = np.array([0, 0, 1])
        self.jlc.joints[5]['motion_rng'] = [-1.8326, 2.87979]
        self.jlc.joints[6]['pos_in_loc_tcp'] = np.array([0, 0, -0.235])
        self.jlc.joints[6]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.joints[6]['motion_rng'] = [-1.74533, 1.74533]
        self.jlc.joints[7]['pos_in_loc_tcp'] = np.array([-0.047, 0, -0.09])
        self.jlc.joints[7]['loc_motionax'] = np.array([1, 0, 0])
        self.jlc.joints[7]['motion_rng'] = [-2.84489, 2.84489]
        self.jlc.lnks[2]['name'] = "jlc_joint0"
        self.jlc.lnks[2]['pos_in_loc_tcp'] = np.array([0, 0.145, 0.370296])
        ...
        self.jlc.lnks[4]['pos_in_loc_tcp'] = np.array([0, 0.095, -0.25])
        ...
        self.jlc.lnks[5]['pos_in_loc_tcp'] = np.array([-0.03, 0, 0])
        ...
        self.jlc.lnks[6]['pos_in_loc_tcp'] = np.array([0, 0, -0.235])
...
#         self.lft_arm.lnks[3]['pos_in_loc_tcp'] = np.array([0, 0, 0])
...
#         self.lft_arm.lnks[4]['pos_in_loc_tcp'] = np.array([0, 0.095, -0.25])
...
#         self.lft_arm.lnks[5]['pos_in_loc_tcp'] = np.array([-0.03, 0, 0])
...
#         self.lft_arm.lnks[6]['pos_in_loc_tcp'] = np.array([0, 0, -0.235])
...
#         self.rgt_arm.lnks[3]['pos_in_loc_tcp'] = np.array([0, 0, 0])
...
#         self.rgt_arm.lnks[4]['pos_in_loc_tcp'] = np.array([0, -0.095, -0.25])
...
#         self.rgt_arm.lnks[5]['pos_in_loc_tcp'] = np.array([-0.03, 0, 0])
...
#         self.rgt_arm.lnks[6]['pos_in_loc_tcp'] = np.array([0, 0, -0.235])
