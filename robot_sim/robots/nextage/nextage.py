...
class Left_Manipulator(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(7), name='nextage_left_manipulator'):
        ...
        self.jlc.jnts[2]['loc_rotmat'] = rm.rotmat_from_euler(-0.261799, 0, 0)
        ...
        self.jlc.lnks[2]['loc_rotmat'] = rm.rotmat_from_euler(-0.261799, 0, 0)
...
#
#
# class Nextage_WSA(ai.ArmInterface):
#     """
...
#         super().__init__(pos=pos, rotmat=rotmat, name=name)
#         self.manipulator = jl.JLChain(pos=self.central_body.jnts[1]['gl_posq'],
