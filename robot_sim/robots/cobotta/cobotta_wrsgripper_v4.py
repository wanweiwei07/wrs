...
import robot_sim.end_effectors.gripper.wrs_gripper.wrs_gripper_v4 as cbtp
import robot_sim.robots.single_arm_robot_interface as rsi
import basis.robot_math as rm


class CobottaLarge(rsi.SglArmRobotInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), name="cobotta_largehand", enable_cc=True):
        ...
        # gripper
        self.end_effector = cbtp.WRSGripper4(pos=self.manipulator.gl_flange_pos,
