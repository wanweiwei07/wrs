...
import robot_sim.end_effectors.gripper.wrs_gripper.wrs_gripper_v3 as end_effector
import robot_sim.robots.single_arm_robot_interface as ai


class KHI_WG3(ai.SglArmRobotInterface):
...
if __name__ == '__main__':
    ...
    gm.gen_frame(pos=tgt_pos, rotmat=tgt_rotmat, ax_length=1).attach_to(base)
    # base.run()
