...
class Box(URDFType):
    ...
    def meshes(self):
        ...
        if len(self._meshes) == 0:
            self._meshes = [trm.creation.box(extents=self.size)]
        return self._meshes
...
class Cylinder(URDFType):
    ...
    def meshes(self):
        ...
        """
        if len(self._meshes) == 0:
            self._meshes = [trm.creation.cylinder(
...
class Sphere(URDFType):
    ...
    def meshes(self):
        ...
        """
        if len(self._meshes) == 0:
            self._meshes = [trm.creation.icosphere(radius=self.radius)]
        return self._meshes
    ...
    def get_child_pose(self, cfg=None):
        ...
        if cfg is None:
            ...
            if cfg is None:
                ...
                cfg = float(cfg)
            R = trm.transformations.rotation_matrix(cfg, self.axis)
...
class URDF(URDFType):
    ...
    The URDF encapsulates an articulated object, such as a robot or a gripper. It is made of links and joints that tie
    ...
    def __init__(self, name, links, joints=None, transmissions=None, materials=None, other_xml=None):
        """
        The top-level URDF specification.
        The URDF encapsulates an articulated object, such as a robot or a gripper. It is made of links and joints that
