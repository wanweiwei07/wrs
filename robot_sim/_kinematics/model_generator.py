...
def gen_anchor(anchor,
    ...
    mgm.gen_sphere(pos=anchor.pos,
                   radius=radius,
                   rgba=rm.bc.jnt_parent_rgba).attach_to(m_col)
        ...
        if toggle_actuation:
            if jnt.type == rkc.JntType.REVOLUTE:
                ...
                mgm.gen_circarrow(axis=jnt.gl_motion_ax,
                                  ...
                                  rgba=rm.bc.red).attach_to(m_col)
