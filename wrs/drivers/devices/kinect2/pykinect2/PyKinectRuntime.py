...
import numpy
import time
from wrs.drivers.devices.kinect2.pykinect2 import PyKinectV2
    ...
    def get_last_color_frame(self):
        with self._color_frame_lock:
            if self._color_frame_data is not None:
                ...
                self._last_color_frame_access = time.time()
                return data
            else:
                return None
    ...
    def get_last_infrared_frame(self):
        with self._infrared_frame_lock:
            if self._infrared_frame_data is not None:
                ...
                self._last_infrared_frame_access = time.time()
                return data
            else:
                return None
    ...
    def get_last_depth_frame(self):
        with self._depth_frame_lock:
            if self._depth_frame_data is not None:
                ...
                self._last_depth_frame_access = time.time()
                return data
            else:
                return None
    ...
    def get_last_body_index_frame(self):
        with self._body_index_frame_lock:
            if self._body_index_frame_data is not None:
                ...
                self._last_body_index_frame_access = time.time()
                return data
            else:
                return None
    ...
    def get_last_body_frame(self):
        with self._body_frame_lock:
            if self._body_frame_bodies is not None:
                self._last_body_frame_access = time.time()
        ...
        try:
            ...
            try:
                with self._depth_frame_lock:
                    ...
                    self._last_depth_frame_time = time.time()
            except:
                pass
            depthFrame = None
        except:
        ...
        try:
            ...
            try:
                with self._body_frame_lock:
                    ...
                    self._last_body_frame_time = time.time()
        ...
        try:
            ...
            try:
                with self._body_index_frame_lock:
                    ...
                    self._last_body_index_frame_time = time.time()
            except:
                pass
            bodyIndexFrame = None
        except:
        ...
        try:
            ...
            try:
                with self._infrared_frame_lock:
                    ...
                    self._last_infrared_frame_time = time.time()
            except:
                pass
            infraredFrame = None
        except:
