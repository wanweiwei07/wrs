...
import wrs.robot_sim.end_effectors.grippers.robotiq85.robotiq85 as end_effector


class Diana7_Rtq85(sari.SglArmRobotInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), ik_solver='d', name="diana7_rtq85", enable_cc=True):
        ...
        self.end_effector = end_effector.Robotiq85(pos=self.manipulator.gl_flange_pos,
...
if __name__ == '__main__':
    ...
    robot = Diana7_Rtq85(enable_cc=True)
