...
class Diana7_Dual(dari.DualArmRobotInterface):
    ...
    date: 20221118, 20231027, 20241031
    """
    ...
    def __init__(self, pos=rm.np.zeros(3), rotmat=rm.np.eye(3), name='diana7_dual', enable_cc=True):
        ...
        # left arm
        self._lft_arm = d7r85.Diana7_Rtq85(pos=self._body.gl_flange_pose_list[0][0],
    ...
    def _enable_lft_cc(self):
        ...
        self._lft_arm.cc.set_cdpair_by_ids(from_list, into_list)
        # ext and inner
        self._lft_arm.cc.enable_extcd_by_id_list(id_list=[lft_ml2, lft_ml3, lft_ml4, lft_ml5] + lft_ee_cces,
                                                 type="from")
    ...
    def _enable_rgt_cc(self):
        ...
        self._rgt_arm.cc.set_cdpair_by_ids(from_list, into_list)
        # ext and inner
        self._rgt_arm.cc.enable_extcd_by_id_list(id_list=[rgt_ml2, rgt_ml3, rgt_ml4, rgt_ml5] + rgt_ee_cces,
                                                 type="from")
