...
import wrs.robot_sim.robots.diana7_dual.diana7_calib as d7calib
...
class Diana7_Dual(dari.DualArmRobotInterface):
    ...
    def __init__(self, pos=rm.np.zeros(3), rotmat=rm.np.eye(3), name='diana7_dual', enable_cc=True):
        ...
        # left arm
        self._lft_arm = d7calib.Diana7_Calib(pos=self._body.gl_flange_pose_list[0][0],
...
if __name__ == '__main__':
    ...
    base = wd.World(cam_pos=[5, 0, 3], lookat_pos=[0, 0, 1], auto_rotate=True)
