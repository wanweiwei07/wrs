...
if __name__ == '__main__':
    ...
    mt.convert_to_stl("robotiq_85_inner_finger_gelsight.stl", "robotiq_85_inner_finger_gelsight_cvt.stl", scale_ratio=1, rotmat=rm.rotmat_from_axangle([0,0,1], math.pi/2))