...
class ShuidiX(object):
    ...
    def move_to_marker(self, target_name, uuid=1, max_continuous_retries=30, distance_tolerance=None,
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "move",
                                                    {"marker": target_name,
    ...
    def cancel_move(self, uuid=1):
        ...
        取消当前正在进行的移动指令
        """
        command = ShuidiX.generate_request_data(uuid, "move/cancel")
        return self.data_send_recv(command)
    ...
    def robot_status(self, uuid=1):
        ...
        """
        command = ShuidiX.generate_request_data(uuid, "robot_status")
        return self.data_send_recv(command)
    ...
    def robot_info(self, uuid=1):
        ...
        调用接口可以获取机器人的一些基本信息。
        """
        command = ShuidiX.generate_request_data(uuid, "robot_info")
        return self.data_send_recv(command)
    ...
    def marker_insert_by_pose(self, x: float, y: float, theta: float, name: str, uuid=1, type=0, num=1,
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "markers/insert_by_pose",
                                                    {"x": x,
                                                     "y": y,
                                                     "theta": theta,
                                                     "floor": floor,
    ...
    def marker_query_list(self, floor=None, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "markers/query_list", {"floor": floor})
        return self.data_send_recv(command)
    ...
    def marker_query_brief(self, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.enerate_request_data(uuid, "markers/query_brief")
        return self.data_send_recv(command)
    ...
    def marker_delete(self, name, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "markers/delete", {"name": name})
        return self.data_send_recv(command)
    ...
    def joy_control(self, uuid=1, linear_velocity=0, angular_velocity=0):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "joy_control",
    ...
    def estop(self, flag=False, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "estop",
    ...
    def position_adjust(self, marker: str, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "position_adjust", {"marker": marker})
        return self.data_send_recv(command)
    ...
    def position_adjust_by_pose(self, x: float, y: float, theta: float, floor=None, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "position_adjust_by_pose",
                                                    {"x": x,
                                                     "y": y,
                                                     "theta": theta,
                                                     "floor": floor})
    ...
    def request_data(self, topic="robot_status", frequency=2, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "request_data",
                                                    {"topic": topic,
                                                     "frequency": frequency})
        return self.data_send_recv(command)
    ...
    def set_params(self, max_speed=None, max_speed_ratio=None, max_speed_linear=None, max_speed_angular=None, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "set_params",
                                                    {"max_speed": max_speed,
    ...
    def get_params(self, uuid=1):
        ...
        """
        command = ShuidiX.generate_request_data(uuid, "get_params")
        return self.data_send_recv(command)
    ...
    def wifi_list(self, uuid=1):
        ...
        """
        command = ShuidiX.generate_request_data(uuid, "wifi/list")
        return self.data_send_recv(command)
    ...
    def wifi_connect(self, SSID, password=None, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "wifi/connect",
    ...
    def wifi_get_active_connection(self, uuid=1):
        ...
        获取机器人当前连接的WiFi的SSID.
        """
        command = ShuidiX.generate_request_data(uuid, "wifi/get_active_connection")
        return self.data_send_recv(command)
    ...
    def wifi_info(self, uuid=1):
        ...
        """
        command = ShuidiX.generate_request_data(uuid, "wifi/info")
        return self.data_send_recv(command)
    ...
    def wifi_detail_list(self, uuid=1):
        ...
        """
        command = ShuidiX.generate_request_data(uuid, "wifi/detail_list")
        return self.data_send_recv(command)
    ...
    def map_list(self, uuid=1):
        ...
        获取机器人中所有的地图名称和楼层。
        """
        command = ShuidiX.generate_request_data(uuid, "map/list")
        return self.data_send_recv(command)
    ...
    def map_list_info(self, uuid=1):
        ...
        获取机器人中所有的地图的详细信息。
        """
        command = ShuidiX.enerate_request_data(uuid, "map/list_info")
        return self.data_send_recv(command)
    ...
    def map_set_current_map(self, map_name, floor, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "map/set_current_map",
    ...
    def map_get_current_map(self, uuid=1):
        ...
        获取机器人当前地图。
        """
        command = ShuidiX.generate_request_data(uuid, "map/get_current_map")
        return self.data_send_recv(command)
    ...
    def shutdown(self, reboot=False, delay=0, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "shutdown",
    ...
    def set_luminance(self, value, uuid=1):
        # TODO: value [0-100]
        command = ShuidiX.generate_request_data(uuid, "LED/set_luminance", {"value": value})
        return self.data_send_recv(command)

    def set_luminance(self, r, g, b, uuid=1):
        # TODO: r g b [0-100]
        command = ShuidiX.generate_request_data(uuid, "LED/set_color", {"r": r, "g": g, "b": b})
        return self.data_send_recv(command)
    ...
    def diagnosis_get_result(self, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "diagnosis/get_result")
        return self.data_send_recv(command)
    ...
    def get_power_status(self, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "get_power_status")
        return self.data_send_recv(command)
    ...
    def get_planned_path(self, uuid=1):
        ...
        :return:
        """
        command = ShuidiX.generate_request_data(uuid, "get_planned_path")
        return self.data_send_recv(command)
    ...
    def make_plan(self, start_x, start_y, start_floor, goal_x, goal_y, goal_floor, uuid=1):
        ...
        """
        command = ShuidiX.generate_request_data(uuid, "make_plan",
                                                    {"start_x": start_x,
                                                     "start_y": start_y,
