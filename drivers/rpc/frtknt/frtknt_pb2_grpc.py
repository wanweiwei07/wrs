...
import robotconn.rpc.frtknt.frtknt_pb2 as frtknt__pb2
...
class KntStub(object):
  ...
  def __init__(self, channel):
    ...
    self.getrgbimg = channel.unary_unary(
        ...
        response_deserializer=frtknt__pb2.CamImg.FromString,
        )
    ...
    self.getpcd = channel.unary_unary(
        '/Knt/getpcd',
        request_serializer=frtknt__pb2.Empty.SerializeToString,
        response_deserializer=frtknt__pb2.PointCloud.FromString,
        )
...
def add_KntServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'getpcd': grpc.unary_unary_rpc_method_handler(
          servicer.getpcd,
          request_deserializer=frtknt__pb2.Empty.FromString,
          response_serializer=frtknt__pb2.PointCloud.SerializeToString,
      ),
