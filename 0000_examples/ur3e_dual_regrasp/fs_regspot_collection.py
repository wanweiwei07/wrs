...
spot_pos0 = rm.np.array([.8, .35, .9])
spot_pos1 = rm.np.array([.8, .45, .9])
spot_pos2 = rm.np.array([.8, .5, .9])
...
# base.run()
fsregspot_collection.add_new_spot(spot_pos=spot_pos2, barrier_z_offset=None, spot_rotz=0)
