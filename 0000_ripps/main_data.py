...
if __name__ == '__main__':
    ...
    for id_x in range(8):
        for id_y in range(9):
            ...
            microplate24 = microplate24_0
            if id_x < 4 and id_y >= 6:
                microplate24 = microplate24_1
                id_x = id_x
                id_y = id_y - 6
            if id_x >= 4 and id_y < 6:
                microplate24 = microplate24_2
                id_x = id_x - 4
                id_y = id_y
            if id_x >= 4 and id_y >= 6:
                microplate24 = microplate24_3
                id_x = id_x - 4
                id_y = id_y - 6
            well_pos, well_rotmat = microplate24.get_rack_hole_pose(id_x=id_x, id_y=id_y)
    ...
    #         break
    #     else:
    #         ee_s.grip_at_with_jcpose(jaw_center_pos=pos + z_offset, jaw_center_rotmat=rotmat, jaw_width=0)
