...
if __name__ == '__main__':
    ...
    # relpos = phoxi_computeboardcenterinhand(yhx, pxc, armname, parameters, aruco_dict)
    # phoxi_calibbyestinee(yhx, pxc, armname, parameters, aruco_dict)
    ...
    # phoxi_calib_refine(yhx, pxc, rawamat, armname="rgt")
    # yhx.rbt.movearmfk(yhx.getarmjntsx("rgt"), armname="rgt")
    # yhx.rbt.movearmfk(yhx.getarmjntsx("lft"), armname="lft")
