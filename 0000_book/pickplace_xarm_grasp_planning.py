...
object_box = cm.gen_box(extent=[.02, .06, .2])
object_box.set_rgba([.7, .5, .3, 1])
object_box.attach_to(base)
# hnd_s
gripper_s = xag.XArmGripper()
grasp_info_list = gpa.plan_grasps(gripper_s, object_box, max_samples=7, min_dist_between_sampled_contact_points=.03)
gpa.write_pickle_file('box', grasp_info_list, './', 'xarm_box.pickle')
