...
# # mgm.gen_dashstick(pos_start, pos_end, major_radius=.001, rgba=[0, 0, 0, .3], len_solid=.005, len_interval=.005).attach_to(base)
# mgm.gen_stick(pos_start, pos_end, major_radius=.001, rgba=[0, 0, 0, .3]).attach_to(base)
...
# mgm.gen_dashstick(pos_o, np.array([pos_o[0], pos_o[1], 0]), major_radius=.001, rgba=[0,0,0,.3], len_solid=.005, len_interval=.005).attach_to(base)
...
# mgm.gen_dashstick(pos_o, np.array([pos_o[0], 0, pos_o[2]]), major_radius=.001, rgba=[0,0,0,.3], len_solid=.005, len_interval=.005).attach_to(base)
