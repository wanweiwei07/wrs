...
if __name__ == '__main__':
    # cam
    cam_pos = rm.vec_from_args(1, .8, .6)
    lookat_pos = rm.np.zeros(3)
    # cam for rendering
    cam_pos_for_rendering = rm.vec_from_args(1.5, 1.5, 1)
    lookat_pos_for_rendering = rm.vec_from_args(0, 0, 0)
    # setup world
    ...
    # virtual cam
    cam_res = rm.vec_from_args(1920, 1080)
    screen_size = rm.vec_from_args(0.096, 0.054)
