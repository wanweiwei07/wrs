...
if __name__ == '__main__':
    # cam
    cam_pos = rm.vector(1, .8, .6)
    lookat_pos = rm.zeros(3)
    # cam for rendering
    cam_pos_for_rendering = rm.vector(1.5, 1.5, 1)
    lookat_pos_for_rendering = rm.vector(0, 0, 0)
    # setup world
    ...
    # virtual cam
    cam_res = rm.vector(1920, 1080)
    screen_size = rm.vector(0.096, 0.054)
