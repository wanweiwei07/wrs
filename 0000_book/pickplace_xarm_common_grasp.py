...
for grasp_info in grasp_info_list:
    ...
    if conf_path is None:
        ...
        gl_goal_jaw_center_pos = object_box_gl_goal_pos + object_box_gl_goal_rotmat.dot(jaw_center_pos)
        gl_goal_jaw_center_rotmat = object_box_gl_goal_rotmat.dot(jaw_center_rotmat)
        jvs = robot_s.ik(component_name,
                         gl_goal_jaw_center_pos,
                         gl_goal_jaw_center_rotmat)
        if jvs is None:
            continue
