"""
A high-level API for the dynamixel based gripper for the sdk_wrapper.py. Two motors are used to control the gripper.
...
from drivers.devices.dynamixel_sdk.sdk_wrapper import DynamixelMotor
...
if __name__ == "__main__":
    try:
        ...
        if not gp.is_calibrated:
            ...
            print("The gripper is calibrated.")
        gp.open_gripper()
        # gp.open_gripper()
        input("Press to finish...")
        # gp.close_gripper(grasp_force=170)
        # time.sleep(3)
        # gp.close_gripper(grasp_force=200)
        # input("Press Enter to continue...")
        # gp.close_gripper(grasp_force=80, disable_motor_id=2)
        # gp.close_gripper()
