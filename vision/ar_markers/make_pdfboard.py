...
def make_aruco_board(nrow,
    ...
    a4npxrow = int(paperheight*_MM_TO_INCH*dpi)
    a4npxcolumn = int(paperwidth*_MM_TO_INCH*dpi)
    bgimg = np.ones((a4npxrow, a4npxcolumn), dtype='uint8')*255
    markersizepx = int(markersize*_MM_TO_INCH*dpi)
    markerdist = int(markersizepx/4)
    if framesize is not None:
        framesize[0] = int(framesize[0]*_MM_TO_INCH*dpi)
        framesize[1] = int(framesize[1]*_MM_TO_INCH*dpi)
...
def make_charuco_board(nrow,
    ...
    if framesize is not None:
        ...
        bgimg[frametop:frametop+1, framelft:framergt+1]=0
        bgimg[framedown:framedown+1, framelft:framergt+1]=0
    squaresizepx = int(squaresize*_MM_TO_INCH*dpi)
...
def make_chess_and_charuco_board(nrowchess=3,
                                 ncolumnchess=5,
                                 squaresize=25,
                                 nrowcharuco=3,
                                 ncolumncharuco=5,
    ...
    if framesize is not None:
        ...
        bgimg[framedown:framedown+1, framelft:framergt+1]=0
    # upper half, charuco
    squaresizepx = int(squaresizearuco*_MM_TO_INCH*dpi)
...
if __name__ == '__main__':
    ...
    make_aruco_board(1, 1, markerdict=aruco.DICT_4X4_250, startid=2, markersize=45, framesize=[60, 60])
