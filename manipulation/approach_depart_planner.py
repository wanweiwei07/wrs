...
class ADPlanner(object):  # AD = Approach_Depart
    ...
    def gen_approach_primitive(self,
                               component_name,
                               goal_hnd_pos,
                               goal_hnd_rotmat,
...
if __name__ == '__main__':
    ...
    for i, conf_value in enumerate(conf_list):
        ...
        yumi_instance.jaw_to(jawwidth_list[i], hnd_name)
